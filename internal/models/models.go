...
// Package models holds the request/response DTOs and config data structures
// shared across the Intermasq packages. It has no dependencies on the rest
// of the codebase and is a leaf package.
package models
