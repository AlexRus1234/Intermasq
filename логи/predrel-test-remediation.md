...
| **P3** | — | `predrel-test-remediation-p3.md` | полиш: 9 задач — A11/Success-fake, инвертированные комментарии, mutation-friendly селекторы, покрытие endoints | ~1 день | до v1.0 release — не начато |
