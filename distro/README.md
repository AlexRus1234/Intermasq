...
В каждой сети четыре mock-устройства: первое активно (зелёная лампочка online),
остальные три намеренно offline. Дополнительно генерируются unknown-ARP и новый
DHCP-lease для вкладки «Обнаружение».
